...
以下是 [台積電 2025 Q3 合併財務報告](https://investor.tsmc.com/english/quarterly-results/2025/q3)（公開資訊）經 opendataloader-pdf 轉換的實際輸出。

**損益表** — 數字與閱讀順序完整保留。主要財務報表以結構化文字呈現，針對 LLM 處理最佳化：
